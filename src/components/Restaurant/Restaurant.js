...
const Restaurant = ({restaurant = {}, onEdit}) => {
        ...
        const handleAddToFavorites = async () => {
            await dispatch(favoritesActions.addRestaurantToFavorites({
                id,
                userName,
                restaurant
            }))
            ...
            <div className="super-main">
                <div className="restaurant-main-container">
                    ...
                    <div className={"restaurant-button-container"}>
                        ...
                        {editButton()}
                        {addReviewButton()}
                        {addGeneralNewsButton()}
                        {addPromotionNewsButton()}
                        {addEventNewsButton()}
                        {addBookingButton()}
                        {toFavoritesButton()}
                    </div>
